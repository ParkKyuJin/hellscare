...
<script>
	var eat1 = ${userWeeklyKcalList.get(0).total_kcal};
	var eat2 = ${userWeeklyKcalList.get(1).total_kcal};
	var eat3 = ${userWeeklyKcalList.get(2).total_kcal};
	var eat4 = ${userWeeklyKcalList.get(3).total_kcal};
	var eat5 = ${userWeeklyKcalList.get(4).total_kcal};
	var eat6 = ${userWeeklyKcalList.get(5).total_kcal};
	var eat7 = ${userWeeklyKcalList.get(6).total_kcal};
