		...
		<section id="content">
			<div class="content-wrap">
				<div class="container clearfix">
					<div>
						<div class="col-lg-12">
							<form action="club_BoardModifyPro" method="post">
								<input type="hidden" name="club_name" value="${club_name}">
								<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
								<input type="hidden" name="club_board_code" value="${club_board_code}">
								
								<div class="col-12 form-group">
									<h4>제목:</h4>
									<input type="text" name="title" id="title" class="form-control required" placeholder="제목 입력" value="${vo.title}">
								</div>
								...
								<div class="col-12 form-group">
									...
									<div class="form-group" style="vertical-align: middel">
										<h4>내용:</h4>
										<textarea name="content"  cols="30" rows="10" style="width:800px; height:200px;">${vo.content}</textarea>
									</div>
								</div>
