                                             ...
                                             function insRow() {
                                                ...
                                                $("#addTable tr").focusin(function() {
                                                   ...
                                                   $(document.today_cal_form.food_kind[row]).change(function() {
                                                      ...
                                                      console.log("food_kind : " + food_kind);
                                                      ...
                                                      $.ajax({
                                                         ...
                                                         success : function(data) {
                                                            ...
                                                            var html = "<ul id=ul"+ row + ">";
                                                            $.each(data, function(i, v){
                                                               //console.log(i);
                                                               //console.log(v);
                                                               html += "<li><a href=# id=food" + row + i + " >"+v.food_name+"</a></li>";
                                                            });
                                                            html += "</ul>";
                                                            ...
                                                            $("#food_name_list" + cellCount + " ul li a").click(function() {
                                                               ...
                                                               console.log("selected food_name : " + $("#food" + row + index).text());
                                                               
                                                               $("#food_name" + cellCount).val($("#food" + row + index).text());
