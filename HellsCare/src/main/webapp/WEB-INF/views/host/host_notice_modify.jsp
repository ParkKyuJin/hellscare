      ...
      <section class="wrapper">
        ...
        <div class="row mt">
          <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="contact-form php-mail-form" role="form" action="noticeUpdate" method="POST">
              <div class="form-group">
                제목<input type="text" name="subject" class="form-control" id="contact-subject" value="${dto.title}" data-rule="minlen:4" >
                <div class="validate"></div>
              </div>
              
              <input type="hidden" value="${dto.board_code}">
              <div class="form-group">
              ...
              <div class="form-group">
                내용<textarea class="form-control" name="message" id="contact-message"  rows="5" data-rule="required" data-msg="Please write something for us" >${dto.content}</textarea>
                <div class="validate"></div>
              </div>
