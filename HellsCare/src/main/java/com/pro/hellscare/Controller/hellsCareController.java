...
//		}
		...
		// ==한결 Part End==================================================
	/*
	 * @RequestMapping("perse") public String perse(HttpServletRequest req, Model
	 * model) { // 로거 작성 필수! service.perse(req, model);
	 * 
	 * logger.info("URL ==> perse"); return "user/perse"; }
	 */
