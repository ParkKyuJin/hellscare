	            ...
	            case 0 :
	               ...
	               if(getDustValue[0].contains("null")) {
	                  microdust = 0;
	                        ...
	                        microdust = Integer.parseInt(getDustValue[0]);
	                        }
	               ...
	               int superMicrodust;
	                if(getDustValue[0].contains("null")) {
	                   superMicrodust = 0;
	                        ...
	                        superMicrodust = Integer.parseInt(getDustValue[0]);
	                        }
...
//							}
	...
	public void registerFood(MultipartHttpServletRequest req, Model model) {
		...
		// 서버에 맞게 변경
		String realDir = "C:\\Dev50\\git3\\hellscare\\HellsCare\\src\\main\\webapp\\resources\\images\\food\\";
...
//			vo.setBoard_image(file.getOriginalFilename());
	...
	//마이페이지 QnA 작성 처리
			...
			public void MyqnaWritePro(HttpServletRequest req, Model model) {
				...
				System.out.println("마이페이지 문의글 등록 : " + qnaWriteCnt);
